    ...
    public class DistanceScanner : MonoBehaviour
    {
        ...
        void ExecuteDistanceScan()
        {
            ...
            if (Physics.Raycast(ray, out raycastHit, raycastRange))
            {
                ...
                {
                    Vector2Int currentPosition = Client.Instance.Labyrinth.GetWorldPositionInLabyrinthPosition(avatar.transform.position.x, avatar.transform.transform.position.z);
